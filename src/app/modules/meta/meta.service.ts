...
export const fetchDashboardMetaData = async (user: IJWTPayload) => {
  let metadata;
  switch (user.role) {
    case UserRole.ADMIN:
...
export const getDoctorMetaData = async (user: IJWTPayload) => {
...
export const getPatientMetaData = async (user: IJWTPayload) => {
